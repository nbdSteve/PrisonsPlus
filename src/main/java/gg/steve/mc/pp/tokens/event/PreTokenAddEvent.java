...
public class PreTokenAddEvent extends Event implements Cancellable {
    ...
    public PreTokenAddEvent(TokenPlayer player, TokenType type, int amount, AddMethodType addMethod) {
        this.player = player;
        this.type = type;
        this.amount = amount;
