package gg.steve.mc.pp.utility.actionbarapi;
...
//            e.printStackTrace();
    ...
    public static void sendActionBar(final JavaPlugin plugin, final Player player, final String message, int duration) {
